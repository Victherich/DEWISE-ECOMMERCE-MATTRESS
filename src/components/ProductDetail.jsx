...
//       try {
//         const response = await axios.get(`https://www.heovin.com.ng/api/get_product_by_id.php?productId=${productId}`);
...
//               <img key={index} src={`https://www.heovin.com.ng/api/uploads/${image}`} alt={`Product image ${index}`}   onClick={()=>setImageIndex(index)} />
//             ))}
//           </div>

//           <div className='ProductDetailPageMid'>
//             <img src={`https://www.heovin.com.ng/api/uploads/${product.product_images[imageIndex]}`} alt="Main Product" />
//           </div>
      ...
      <div className='ProductDetailPage'>
        <div className='ProductDetailPageLeft'>
          {product.product_images.map((image, index) => (
            <img
              key={index}
              src={`https://www.heovin.com.ng/api/uploads/${image}`}
