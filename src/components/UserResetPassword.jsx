  ...
  return (
    <div className='agentbody'>
      <div className='agentformWrap'>
        <div className='HeaderUpRight1' style={{ color: "orangeRed", fontWeight: "bold" }} onClick={() => navigate("/")}>
        ...
        <form onSubmit={handleSubmit} className='agentForm' style={{ height: "60%" }}>
          <div className='AgentFormPage1'>
            ...
            <div className='agentinput' style={{ position: "relative" }}>
              ...
              />
              {passwordShow === "text" ? 
                <FaEye onClick={() => setPasswordShow("password")} style={{ position: "absolute", top: "50%", right: "10px", cursor: "pointer" }} /> : 
                <FaEyeSlash onClick={() => setPasswordShow("text")} style={{ position: "absolute", top: "50%", right: "10px", cursor: "pointer" }} />}
            </div>
            ...
            <div className='agentinput' style={{ position: "relative" }}>
              ...
              {confirmPasswordShow === "text" ? 
                <FaEye onClick={() => setConfirmPasswordShow("password")} style={{ position: "absolute", top: "50%", right: "10px", cursor: "pointer" }} /> : 
                <FaEyeSlash onClick={() => setConfirmPasswordShow("text")} style={{ position: "absolute", top: "50%", right: "10px", cursor: "pointer" }} />}
              {confirmPasswordError && <p style={{ color: 'red', fontSize: 'small' }}>{confirmPasswordError}</p>}
            </div>

            <button type="submit" className='AgentSignUpNextButton' disabled={isSubmitting}>
