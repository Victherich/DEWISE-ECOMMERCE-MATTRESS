...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://dewisemattress.com/api/admin_login.php', formData, {
        headers: {
  ...
  return (
    <div className='ContactFormWrap' key={location.pathname}>
      <div className='contact-form-container'>
        ...
        <p style={{ marginTop: '10px', position: 'relative', cursor: 'pointer', color: '#003366' }} onClick={() => navigate('/adminforgotpassword')}>
          Forgot Password
        </p>
      </div>
    </div>
