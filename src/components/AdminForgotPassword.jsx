...
const AdminForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://www.heovin.com.ng/api/admin_forgot_password.php", { email });
...
//       Swal.fire({
//         text: response.data.message ? `${response.data.message} Please check your inbox or spam for the reset link.` : "Email sent!",
//         confirmButtonText: 'Ok'
//       });
//       setResendLink(true);
//     } catch (error) {
...
//         const { status, data } = error.response;
//         if (status === 404) {
//           errorMessage = data.error || 'Email not found. Please check your email and try again.';
//         } else if (status === 500) {
//           errorMessage = 'Server error. Please try again later.';
//         }
//       }
...
//             )}
//           </button>
//           <p onClick={() => navigate("/adminlogin")} style={{ color: "orange", cursor: "pointer", textDecoration: "underline" }}>Login</p>
//         </form>
//       </div>
//     </div>
//   );
